...
%%{init: {'theme': 'dark'}}%%
flowchart TB
    subgraph Server["Server Side (Falco)"]
        direction TB
        FalcoServer["Falco Web Server"]
        APIEndpoints["API Endpoints"]
        HTMLRendering["Initial HTML Rendering"]
        
        FalcoServer --> APIEndpoints
        FalcoServer --> HTMLRendering
    end
...
### Mounting in Falco Views

Update your Falco view to include the necessary mounting point:
        ...
        (fun contentId ctx ->
            ...
            let subscription = 
                ...
                (fun updatedContent ->
                    ...
                    ctx.Response.WriteAsync(eventData).Wait()
